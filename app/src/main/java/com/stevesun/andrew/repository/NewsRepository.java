package com.stevesun.andrew.repository;
...
import com.stevesun.andrew.AndrewNewsApplication;
...
public class NewsRepository {
    ...
    private final AndrewNewsDatabase database;

    public NewsRepository(Context context) {
        newsApi = RetrofitClient.newInstance(context).create(NewsApi.class);
        database = ((AndrewNewsApplication) context.getApplicationContext()).getDatabase();
    }
    ...
    private static class FavoriteAsyncTask extends AsyncTask<Article, Void, Boolean> {
        ...
        private FavoriteAsyncTask(AndrewNewsDatabase database, MutableLiveData<Boolean> liveData) {
